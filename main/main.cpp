...
#include <random>
#include "./component/systemCTypes.h"
#include "texture.h"
#include "window.h"
#include "./data/font.h"
#include "./logic/renderLogictest.h"
#include <UnitTest++.h>
#include "./utility/userInput.h"
#include "./logic/bulletLogic.h"
#include "./data/action.h"
#include "./entity/blueprint.h"
#include "./texture/texAnim.h"
...
//    CharSet characterSet(font);
    ...
    bulletBluePrint.linkWith(TagMgr,"Bullet");
    bulletBluePrint.linkWith(TexMgr,new TexAnim("./ship",24));
    bulletBluePrint.linkWith(TransformMgr);
...
*/
                Entity *newEnt = new Entity;
                bulletBluePrint.applyOnto(*newEnt);
            }
